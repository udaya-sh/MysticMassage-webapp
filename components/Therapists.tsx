...
const Therapists = ({ posts }: Props) => {
  return (
    <div
      id="therapists"
      className="relative z-40 -mt-[0vh] min-h-screen text-color  space-y-10 py-20  md:px-[300px] bg-[#222222] "
    >
      <div className="max-w-[1240px] gap-8 text-color ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 md:gap-6 p-2 md:p-6 ">
          {posts.map((post) => (
            <div className="w-full   md:w-[500px] md:hover:scale-105 transition-transform duration-200 ease-in-out md:mr-20 md:mb-10 md:hover:border-[1px] border-[#E65728] rounded-lg cursor-pointer overflow-hidden">
